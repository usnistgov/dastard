...
### Golang 1.26+ is required

**Dastard requires Go version 1.26 or higher** (released August 2025) to take advantage of certain language constructs including `test.loop` loops. Dastard is tested automatically on versions 1.26 and _stable_, [the most recent stable version](https://github.com/actions/go-versions/blob/main/versions-manifest.json) (as of July 31, 2026, that means Go version 1.27.0).
- If you need to run Go version 1.25: [Dastard version 0.3.10](https://github.com/usnistgov/dastard/releases/tag/v0.3.10) is the last version compatible with it.
- If you need to run Go version 1.24: [Dastard version 0.3.9](https://github.com/usnistgov/dastard/releases/tag/v0.3.9) is the last version compatible with it.
